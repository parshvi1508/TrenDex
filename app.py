...
if st.button("Fetch and Predict"):
    ...
    if data is not None:
        ...
        st.write("Future Price Predictions for Next 5 Days:")
        ...
        sma_period = st.slider("Simple Moving Average Period", 5, 50, 20)
        ema_period = st.slider("Exponential Moving Average Period", 5, 50, 50)
        data_with_moving_averages = add_moving_averages(data, sma_period, ema_period)
